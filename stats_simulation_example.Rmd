...
for (k in 1:sims){ #this outer for loop runs the simulations 20,000 times
      for (j in 1:7){ #this for loop is looping through each seven possible production levels: from 30k to 60k)
            ...
            for (i in 1:10){ #profit for each of the 10 years of production
